...
*
*          Created On: 2022年12月14日 星期三 20时03分43秒
...
Eigen::Matrix<SCALAR_T, 6, 3> getWholeBodyMomentumZyxGradient(const PinocchioInterfaceTpl<SCALAR_T>& interface,
  ...
  switch (info.wholebodyModelType) {
    case WholeBodyModelType::WholeBodyDynamics: {
        //TODO:
        std::cout << " dooooo nothing! " << std::endl;
        break;
    }
    /*
    ...
    case WholeBodyModelType::SingleRigidBodyDynamics: {
      Ibaseframe = info.WholeBodyInertiaNominal;
  ...
  if (info.wholebodyModelType == WholeBodyModelType::WholeBodyDynamics) {
    std::cout << " dooooo nooooooothing! " << std::endl;
  }
  /*
